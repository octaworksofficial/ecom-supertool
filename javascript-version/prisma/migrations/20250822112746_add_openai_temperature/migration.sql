...
INSERT INTO "new_TrendyolSettings" ("apiKey", "assistantId", "checkInterval", "createdAt", "id", "isActive", "openaiApiKey", "openaiMaxTokens", "openaiModel", "secretKey", "sellerId", "updatedAt") SELECT "apiKey", "assistantId", "checkInterval", "createdAt", "id", "isActive", "openaiApiKey", "openaiMaxTokens", "openaiModel", "secretKey", "sellerId", "updatedAt" FROM "TrendyolSettings";
